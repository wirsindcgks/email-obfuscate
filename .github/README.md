<!-- Erzeugt aus readme.txt mit `php bin/readme-md.php`, nicht von Hand bearbeiten. -->

# Email Obfuscate

Version 1.3.4 · WordPress ab 6.4 · PHP ab 8.1 · Lizenz: [GPLv2 or later](https://www.gnu.org/licenses/gpl-2.0.html)
...
### 1.3.4
* Autor und Plugin-Seite in der Plugin-Liste verlinkt
* Anleitung auf GitHub sauber formatiert
